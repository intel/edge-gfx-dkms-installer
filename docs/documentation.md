...
- DKMS build/install (and optional `.deb` packaging): `docs/build-install-guide.md`
- Verify module override: `docs/build-install-guide.md`
- Enable SR-IOV boot params + create VFs: `docs/sriov-guide.md`
- Uninstall: `docs/build-install-guide.md`
- Rebuild after kernel update: `docs/build-install-guide.md`
...
See `docs/build-install-guide.md` ("Building a Distributable .deb Package").
