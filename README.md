...
Behind a proxy? See [`docs/build-install-guide.md`](docs/build-install-guide.md#using-a-proxy-optional).
...
| Document | Contents |
|----------|----------|
| [`docs/build-install-guide.md`](docs/build-install-guide.md) | Build, install, verify, uninstall, rebuild after kernel update, optional `.deb` packaging |
| [`docs/sriov-guide.md`](docs/sriov-guide.md) | Enable SR-IOV at boot + create Virtual Functions (VFs) |
| [`docs/build-failures.md`](docs/build-failures.md) | Build failures quick reference |
| [`docs/documentation.md`](docs/documentation.md) | Extension guide: adding patches, new kernel series, updating snapshots, compat shims, helper scripts reference |
| [`docs/SECURITY.md`](docs/SECURITY.md) | Security policy and vulnerability reporting process |
| [`docs/license.md`](docs/license.md) | Project license (MIT) |
...
See [`docs/build-install-guide.md`](docs/build-install-guide.md) ("Building a Distributable .deb Package").
